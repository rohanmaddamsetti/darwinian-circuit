...
md"""
# darwinian-circuit-quasispecies-model-v0.3.jl 
...
begin
	...
	SIGMA = 5.0 ## set the width of the fitness function
...
function ZeroBasedBinomialSwitchingEntry(a, b, plasmid_copy_num)
	""" Input parameters:
	    ...
	    n: total plasmid copy number. """
	p = b/plasmid_copy_num ## probability of sampling a plasmid with the tetA transposon.
	k = a ## number of times that the tetA-transposon plasmid picked from parent into offspring.
	return pdf(Binomial(plasmid_copy_num, p), k)
end
...
PCNSlider = @bind PCN Slider(1:50, default=30, show_value=true)
...
md""" See page 35 of Nowak's book, Evolutionary Dynamics to see discussion of eigenanalysis and analytical solution of the quasispecies equation. \
\
...
scaled_copy_num_covariance_vec = copy_num_covariance_vec .* [BigFloat(1.0)/BigFloat(x) for x in pulse_mean_fitness_vec]

# ╔═╡ 8399e9e1-e411-47c1-9e82-6caed9f765db
...
[1/x for x in pulse_mean_fitness_vec]
...
git-tree-sha1 = "41d2ba41a6b6a3111c26c5015de4873b3958cf76"
